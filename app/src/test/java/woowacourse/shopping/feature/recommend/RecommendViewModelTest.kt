...
class RecommendViewModelTest {
    ...
    private val beverageProducts = TestProductFixture.products(5, category = "음료")
    private val clothesProducts = TestProductFixture.products(5, category = "의류", startIndex = 6)
