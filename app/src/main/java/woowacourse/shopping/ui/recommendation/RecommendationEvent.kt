...
sealed interface RecommendationEvent {
    data class SnackbarEvent(val errorMsg: String) : RecommendationEvent

    data class AddToCart(val purchaseProduct: PurchaseProduct) : RecommendationEvent
    data class UpdateAmount(val targetID: Long, val updateAmount: Int) : RecommendationEvent
