package woowacourse.shopping.ui.shopping.items
...
import woowacourse.shopping.ui.common.item.CirclePlusBtn
...
fun Int.toPriceString(): String {
    ...
    return stringResource(R.string.label_price_unit, formatter.format(this))
}
