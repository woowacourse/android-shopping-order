...
class RecentProductLocalDataSourceImpl(
    ...
    override suspend fun getRecentProducts(limit: Int): List<RecentProductEntity> = recentProductDao.getRecentProducts(limit)

    override suspend fun getRecentViewedProductCategory(): String? = recentProductDao.getRecentViewedProductCategory()

    override suspend fun insertRecentProduct(recentProduct: RecentProductEntity) {
