...
class RetrofitProductDataSource(
    ...
    override suspend fun post(productRequest: ProductRequest): Result<Message<Unit>> =
        runCatching {
    ...
    override suspend fun getById(id: Int): Result<Message<ProductResponse>> =
        runCatching {
    ...
    override suspend fun deleteById(id: Int): Result<Message<Unit>> =
        runCatching {
