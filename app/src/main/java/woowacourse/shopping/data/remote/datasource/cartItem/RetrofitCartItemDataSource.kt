...
class RetrofitCartItemDataSource(
    ...
    override suspend fun getAllByPaging(
        page: Int,
        size: Int,
    ): Result<Message<CartsResponse>> = runCatching {
    ...
    override suspend fun post(cartItemRequest: CartItemRequest): Result<Message<Int>> = runCatching {
    ...
    override suspend fun delete(id: Int): Result<Message<Unit>> = runCatching {
    ...
    ): Result<Message<Unit>> = runCatching {
    ...
    override suspend fun getCount(): Result<Message<QuantityResponse>> = runCatching {
