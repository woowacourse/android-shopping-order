...
class ProductRepositoryImpl(
    ...
    override fun getProducts(
        ...
        remoteProductDataSource.getProducts(category, page, size, sort).enqueue(object : Callback<ProductResponse> {
...
//        }
    ...
    override fun getProductById(
        ...
        remoteProductDataSource.getProductById(id).enqueue(object : Callback<Product> {
