...
import woowacourse.shopping.data.remote.coupon.CouponApiService
...
import woowacourse.shopping.data.remote.coupon.CouponRemoteException
import woowacourse.shopping.data.remote.coupon.CouponResponseDto
...
class CouponRepositoryImpl(
    ...
    override suspend fun getCoupons(): List<Coupon> =
        withContext(Dispatchers.IO) {
            ...
            runCatching {
                responseBody.map(CouponResponseDto::toDomain)
            }.getOrElse { throwable ->
