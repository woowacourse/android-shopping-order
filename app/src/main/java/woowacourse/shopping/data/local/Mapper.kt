...
fun CartEntity.toDomain(): Cart = Cart(id = id.toLong(), product = Product(id = id, name = name, price = price, imageUrl = imageUrl, category = null), quantity = quantity)

fun HistoryEntity.toDomain(): Cart =
    Cart(id = id.toLong(), product = Product(id = id, name = name, price = price, imageUrl = imageUrl, category = null), quantity = quantity)
