...
interface CartDataSource {
    fun loadCarts(currentPage: Int, productSize: Int): Result<CartPageData>
    fun loadTotalCarts(): Result<CartPageData>
    fun createCartProduct(productId: Long, count: Int): Result<Long>
    fun updateCartCount(cartId: Long, count: Int): Result<Unit>
