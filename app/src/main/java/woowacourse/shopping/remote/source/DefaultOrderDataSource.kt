...
class DefaultOrderDataSource(
    ...
    override suspend fun saveOrderItem(orderItem: OrderItem): Result<Unit> =
        runCatching {
            val found =
                orders.find {
    ...
    override suspend fun removeOrderItem(orderItem: OrderItem): Result<Unit> =
        runCatching {
    ...
    override suspend fun loadAllOrders(): Result<List<OrderItem>> =
        runCatching {
            orders
        }
