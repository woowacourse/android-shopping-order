...
object DummyData {
    ...
    val STUB_CART_A = CartDto(id = Cart.EMPTY_CART_ID, quantity = 0, productDto = STUB_PRODUCT_A)
    ...
    val STUB_CART_B = CartDto(id = 2, quantity = 0, productDto = STUB_PRODUCT_B)
    ...
    val STUB_CART_C = CartDto(id = 3, quantity = 0, productDto = STUB_PRODUCT_C)
