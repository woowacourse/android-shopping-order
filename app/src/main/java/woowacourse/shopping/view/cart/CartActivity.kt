...
class CartActivity :
    ...
    private fun initDataBinding() {
        ...
        binding.onOrder = {
            val cartProductItems: Set<CartItemType.ProductItem> =
                viewModel.selectedCartItems.value ?: emptySet()
            val cartItems: List<CartItem> = cartProductItems.map { it.cartItem }
            val intent =
